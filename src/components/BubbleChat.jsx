...
<div class="flex flex-col w-full       ">
   <div class="flex flex-col w-full    border-gray-2 rounded-lg rounded-es-xl ">
     ...
     <span class="text-sm font-semibold  text-gray-900 dark:text-white"></span>
      ...
      <div class="flex items-start rounded-md border shadow-md  dark:bg-gray-600  p-2">
         <div class=" w-full">
         ...
         <div class="inline-flex   self-center items-end">
         <button class="inline-flex self-start items-start p-2 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100  focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-600" type="button">
