...
function EkhtesasNews() {
  return (
    <Col lg={24}>
        <div className='  flex flex-row m-1 p-1 text-white bg-blue-500 sticky top-0 font-bold  justify-center rounded-lg'>
